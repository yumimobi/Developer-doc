...
|app_store_id|int64|发布渠道:<br>当os_channel=1时，值为1，代表的是Google Play商店(Android);<br>当os_channel=2时，值为27，代表的是iTunes App Store(iOS);<br>当os_channel=3时，具体值请见[应用商店列表](#store)，代表的是中国Android渠道;|是|
