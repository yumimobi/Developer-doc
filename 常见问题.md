##### 账号创建：
1. 如何注册玉米移动联盟账号？注册需要信息？
-  现阶段开发者需要联系商务同学，注册账号。
-  注册信息：开发者有效邮箱。
2.  账号登录激活？
- 使用邮箱账号，默认密码：00000000，登录玉米移动；
- 首次登录需要完善账号联系信息、结算货币等信息，涉及财务结算，务必保证填写准确无误。
3.  应用创建：应用未上线，如何填写下载链接？
-   可以在下载链接一栏也填写该应用包名，但在上线前务必要联系玉米商务同学，修改为应用正式下载链接，否则可能影响广告效果；
4.  如果链接与申请应用不匹配是否会展示广告？
...
7. 广告ID申请后审核周期，审核中可否测试广告？
- 广告审核周期1个工作日；
- 应用显示审核中，不会影响广告测试及数据展示，但不会产生广告收入；
8. 玉米SDK支持广告形式
- 横幅、插屏、激励视频、开屏、原生
9. 应用更新，是否要使用最新版本SDK？
- 为了保证广告收益，应用更新时，请使用最新版本玉米SDK
10. 应用更新需要暂时关闭广告，如何操作？
...
##### SDK获取：
1. 如何获取SDK？
-  Yumimobi SDK获取，登录账号，“文档中心”-2.2玉米SDK下载即可获取玉米SDK，之后按文档说明接入；
2. 如何查看各版本SDK更新？
